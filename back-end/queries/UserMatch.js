...
module.exports = { UserLikeProfiles, UserDislikeProfiles, checkMatch, GetAllProfilesLikes, CreateMatch}; // Exportez les fonctions pour les utiliser dans d'autres fichiers