      ...
      <form @submit.prevent="modify_profil" class="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            required
            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          <small v-if="username.length > 20" class="text-red-500"
        ...
        <div>
          ...
          <input
            ...
            required
            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          <small v-if="firstname.length > 30" class="text-red-500"
        ...
        <div>
          ...
          <input
            ...
            required
            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          <small v-if="lastname.length > 30" class="text-red-500"
        ...
        <div>
          ...
          <input
            ...
            maxlength="20"
            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          <small v-if="verify_password.length > 20" class="text-red-500"
...
async function modify_profil() {
  try {
    ...
    if (axios.isAxiosError(error)) {
      message.value = error.response?.data?.message || "Modification failed";
    } else {
      message.value = "Modification failed";
    }
  }
}
