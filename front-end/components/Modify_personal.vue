    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      ...
      <form @submit.prevent="modify_profil" class="space-y-6">
        ...
        <div>
          ...
          <small v-if="verify_password && isPasswordComplex" class="text-green-500">
...
const modify_profil = async () => {
  try {
    const response = await axios.post('http://localhost:3005/api/after_auth/profil/update_profil', {
      email: email.value,
