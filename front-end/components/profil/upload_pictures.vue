<template>
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-12 px-6 overflow-hidden">
    ...
    <!-- Quatre petites photos en dessous (centrées, pas toute la largeur) -->
...
const submitImages = () => {
  ...
  // Logique pour envoyer les images au backend
  console.log('Images soumises:', images.value);
  // Ici, vous pouvez envoyer les images au serveur via une requête HTTP
};
</script>
