    ...
    <div v-if="isConfirmationOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <div class="flex justify-end">
          <button @click="confirmAction" class="bg-red-500 text-white px-4 py-2 rounded mr-2 hover:bg-red-700 transition-colors">
            Oui, signaler
          </button>
          <button @click="closeConfirmation" class="bg-gray-300 px-4 py-2 rounded hover:bg-gray-400 transition-colors">
            Annuler
          </button>
        </div>
      </div>
